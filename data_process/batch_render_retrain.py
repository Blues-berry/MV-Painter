"""
Batch render incomplete training objects using Blender.
Reads from retrain_queue.json and renders each object.
"""
import json
import os
import subprocess
...
def main():
    # Load render queue
    queue_file = '/4T/CXY/MV-Painter/data/train_data/retrain_queue.json'
