...
def main():
    ...
    for step in range(args.steps):
        ...
        for accum_idx in range(args.grad_accum):
            ...
            # PROBE: reg_loss enabled — clear moved AFTER loss so _last_correction
            # is still set when compute_enhanced_loss reads it (matches my v5-faithful).
            # Single-variable control vs v2-era (clear before loss, reg disabled).
