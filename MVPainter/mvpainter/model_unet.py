...
class MVDiffusion(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        noise_pred = self.forward_unet(latents_noisy, t, prompt_embeds, cond_latents,depth_imgs=None,depth_imgs_2 = None,added_cond_kwargs = added_cond_kwargs,is_training = True)
        ...
        if False and self.global_step % 100 == 0 and self.global_rank == 0:  # Disabled for DeepSpeed compatibility
            with torch.no_grad():
                ...
                for i, t in enumerate(timesteps):
                    ...
                    noise_pred = self.forward_unet(latent_model_input, t, prompt_embeds, cond_latents,depth_imgs=None,depth_imgs_2 = None,added_cond_kwargs = added_cond_kwargs,is_training = False)
