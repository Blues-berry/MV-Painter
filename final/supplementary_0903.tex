...
{\large\bfseries Timestep-Conditioned Adapter Scaling for Multi-view Diffusion Texture Generation}\\[4pt]
...
Base checkpoint & Local MVPainter snapshot (\texttt{checkpoints/hf\_repo}; fine-tuned UNet, VAE, and dual CLIP vision encoders; loaded frozen) \\
Adapter checkpoint (main tables) & GeoTex-Adapter \texttt{geotex\_refattn\_v1/geotex\_step\_0002000.pt}; requested scale applied multiplicatively at every injected layer \\
Adapter checkpoint (Sec.~4.7 / FAC / supp.) & \texttt{mvpoutput/geotex\_v2/checkpoints/geotex\_v2\_ema\_final.pt} (MD5 \texttt{a74cc1d16cb473a95022bdcbc58e1b22}, 8.86~MB), applied with per-layer caps deep 3.0 / middle 3.5 / shallow 0.8 \\
